...
namespace kylsim
{
    public class Kylsim
    {
        ...
        public Kylsim()
        {
            ...
            Valve valve2 = new Valve("V2", COL5-40, ROW4, 15, 10, 1, 10, node7, node8, valve1);

            // Create filters
            const int PUSH_UP = 10;
            Filter filter1 = new Filter("F1", COL4, ROW2 - PUSH_UP, 30, 20, 1, 0.0001, 10, node2, node3, valve2);
